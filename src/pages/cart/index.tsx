      ...
      <main className="w-full max-w-5xl mx-auto">
        {cart.length === 0 && (
          <div className="flex w-full flex-col justify-center items-center mt-40">
            ...
            <Link
              className="p-1 px-4 bg-green-600 rounded-xl text-amber-50"
              to={"/"}
            >
              Ir às compras
            </Link>
        ...
        {cart.map((item) => (
          <section
            key={item.id}
            className="flex items-center justify-between border-b-2 border-gray-300 bg-white rounded-2xl px-4"
          >
            <img
