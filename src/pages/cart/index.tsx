      ...
      <main className="w-full max-w-5xl mx-auto">
        ...
        <section className="flex items-center justify-between border-b-2 border-gray-300 bg-white rounded-2xl px-4">
          <img
            ...
            src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcT8RfGyD89MqNeiviyMiC2cf30r17rMSS6vcgmkijdarPCN8ITQIrX4IzqZecyiGBCgJh4NGOLzt1iX9_BzWG0h0AsXRWnx49LfWTesfpteMfg3nzVfnf0yLw"
            alt=""
          />

          <span className="font-bold">R$ 190,00</span>
          ...
          <span className="float-right">Total: R$ 190,00</span>
        </section>
